          ...
          {Weeks?.map((week, index) => {
            ...
            return (
              <div
                ...
                className={`week absolute inset-0 w-full h-full darker-blue small-box-shadow cursor-pointer transition-all duration-300 rounded-md flex justify-center items-center ${isCurrent ? 'z-20 opacity-100 scale-100' : 'z-10 scale-95'}`}
                onClick={() => {
