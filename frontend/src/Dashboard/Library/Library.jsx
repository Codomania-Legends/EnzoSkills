  ...
  return (
    <div ref={containerRef} className="container mx-auto px-4 h-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 h-full w-full pb-30">
        ...
        <div className="white fade-in flex flex-col justify-around medium-box-shadow rounded-[2em] p-6 lg:col-span-3">
        ...
        <div className="white fade-in flex flex-col justify-center items-center medium-box-shadow rounded-[2em] p-8 lg:col-span-1">
        ...
        <div className="white flex flex-col fade-in justify-around medium-box-shadow rounded-[2em] p-6 lg:col-span-3">
        ...
        <div className="white fade-in flex flex-col justify-center medium-box-shadow rounded-[2em] p-8 lg:col-span-1">
