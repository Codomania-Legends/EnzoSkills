...
},
{
  ...
  image: "/About-us/members/Mohini.png",
  links: {
            ...
            <div className="KnowMore-div flex justify-center items-center">
                <div className="KnowMore-Content flex justify-center items-center flex-col">
                    <div className="know-more-top-descip h-[80vh] flex justify-center items-center flex-col relative">
                        <div className="know-more-top-heading flex justify-center items-center mb-5 fade-in">
                            <p className="EnzoSkills-heading-aboutus">
                                EnzoSkills
                            </p>
                        </div>
                        <div className="know-more-top-sub-heading flex justify-center items-center slide-up" style={{animationDelay: '0.4s'}}>
                        ...
                        <a ref={scrollBtnRef} href="#Our_Team" className="scrollDown white absolute bottom-10 z-5 rounded-full p-3 flex justify-center items-center small-box-shadow will-change-transform fade-in animate-bounce" style={{animationDelay: '1s'}}>
                    ...
                    <div id='Our_Team' className="more-about-us-teamsContainer h-[90vh] lg:h-[90vh] md:h-[60vh] flex justify-evenly items-center flex-col">
                        <div className="know-more-top-heading text-5xl flex justify-center items-center reveal-on-scroll reveal-slide-up">
              ...
              <div key={index + member.name} className={`team-card member-container w-full h-full flex justify-center items-center reveal-on-scroll ${index % 2 === 0 ? 'reveal-slide-left' : 'reveal-slide-right'}`}>
                                    <div
                  className={`
                            relative w-[90%] h-full md:h-[80%] md:w-[80%] lg:w-2/3
                  ...
                  "md:ml-15"}
                    ...
                    <div className="more-about-us-Team-Description h-[95vh] w-full flex justify-center items-center">
                        <div className="w-full more-about-us-Team-Description-Content flex justify-evenly h-full items-center flex-col">
                            {members.map((member, index) =>
              <div key={member.role + index} className="w-full flex justify-center items-start flex-col reveal-on-scroll reveal-slide-up" style={{transitionDelay: `${index * 0.2}s`}}>
