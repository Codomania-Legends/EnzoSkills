      ...
      <div className="KnowMore-div flex justify-center items-center">
        <div className="KnowMore-Content flex justify-center items-center flex-col">
          <div className="know-more-top-descip h-[80vh] flex justify-center items-center flex-col relative">
            ...
            }} href="#Our_Team" className="scrollDown white absolute bottom-10 z-5 rounded-full p-3 flex justify-center items-center small-box-shadow">
              <img src="/scroll-down.svg" alt="Scroll Down" className="h-3 w-3"/>
            </a>
          </div>
          <div id='Our_Team' className="more-about-us-teamsContainer h-[80vh] flex justify-evenly items-center flex-col">
            ...
            <div className="About-Team-Description grid grid-cols-1 md:grid-cols-2 gap-10 h-3/4">
              {members.map((member, index) => (
                <div key={index + member.name} className="member-container w-full flex justify-center items-center">
                  <div 
                    className={`
                    ...
                    `}
                  >
                    <div className="member-image flex justify-center items-center p-1 absolute -left-10 bg-[#534DB4] rounded-lg">
                      <img src={member.image} alt={member.name} className="member-image aspect-square h-30 rounded-full md:rounded-2xl lg:rounded-md"/>
                    </div>
                    <div className="member-details flex items-center flex-col w-3/4 h-[80%] text-white justify-evenly pr-5 pl-5 text-sm">
                      ...
                      <div className="member-links flex justify-evenly items-center w-3/4">
                        <a href={member.links.github} target="_blank" rel="noopener noreferrer">
                          <img src="/About-us/members/github.svg" alt="Github" className="member-links h-4 w-4"/>
                        </a>
                        <a href={member.links.linkedin} target="_blank" rel="noopener noreferrer">
                          <img src="/About-us/members/linkedin.svg" alt="Linkedin" className="member-links h-4 w-4"/>
                        </a>
                        <a href={member.links.instagram} target="_blank" rel="noopener noreferrer">
                          <img src="/About-us/members/instagram.svg" alt="Instagram" className="member-links h-4 w-4"/>
                        </a>
                      </div>
                    </div>
                  </div>
          ...
          <div className="more-about-us-Team-Description h-[80vh] w-full flex justify-center items-center">
            <div className="more-about-us-Team-Description-Content flex justify-evenly h-full items-center flex-col">
              {members.map( (member , index) => (
